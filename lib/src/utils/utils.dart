...
/// A mixin that provides utility methods for formatting text.
mixin FormattedTextUtils {
  /// Creates a list of [InlineSpan]s with formatting according to the given
  /// [formatters].
  ///
  /// If [showFormattingCharacters] is true, the formatting characters are
  /// visible with a semi-transparent color.
